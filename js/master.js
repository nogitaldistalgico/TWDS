...
class MasterGame {
        ...
        state.playedCategories.forEach(item => {
            ...
            if (card) {
                ...
                if (item.result === 'lost') {
                    ...
                    const bgSize = (item.result === 'lurch') ? '130%, cover' : 'contain, cover';
    ...
    closeQuestion() {
        ...
        if (this.lastAnswerCorrect) {
            ...
            // Tobi fits perfectly with 'contain'. Lurch needs a Zoom (120%).
            const bgSize = (this.currentTurn === 1) ? '130%, cover, cover' : 'contain, cover, cover';
